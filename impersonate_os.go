...
var firefoxUserAgent = map[ImpersonateOS]g.String{
	...
	android: "Mozilla/5.0 (Android 10; Mobile; rv:143.0) Gecko/134.0 Firefox/143.0",
	ios:     "Mozilla/5.0 (iPhone; CPU iPhone OS 18_2_1 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) FxiOS/143.1 Mobile/15E148 Safari/605.1.15",
}
