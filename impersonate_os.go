...
const chromeSecCHUA = `"Google Chrome";v="143", "Chromium";v="143", "Not A(Brand";v="24"`
...
var chromeUserAgent = map[ImpersonateOS]g.String{
	...
	android: "Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.7499.110 Mobile Safari/537.36",
	ios:     "Mozilla/5.0 (iPhone; CPU iPhone OS 18_7 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) CriOS/143.0.7499.151 Mobile/15E148 Safari/604.1",
}
...
var firefoxUserAgent = map[ImpersonateOS]g.String{
	...
	android: "Mozilla/5.0 (Android 16; Mobile; rv:146.0) Gecko/146.0 Firefox/146.0",
